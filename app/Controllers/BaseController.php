...
abstract class BaseController extends Controller
{
    ...
    protected $sellerSettings = array(); // Add this property to hold the settings
    ...
    protected function loadSettingsForSeller()
    {
        $settingsModel = new SettingsModel();
        $settings = $settingsModel->where('for_seller_app', 1)->findAll();

        $result = [];
        foreach ($settings as $setting) {
            $result[$setting['key']] = $setting['value'];
        }
        $this->sellerSettings = $result;
    }
}
