...
class Seller extends BaseController
{
    ...
    public function list()
    {
        ...
        foreach ($sellers as $row) {
            // Handle logo - use placeholder if empty or null
            $logoUrl = !empty($row['logo']) ? base_url($row['logo']) : base_url('assets/img/no-image.png');
            $img = "<a href='" . $logoUrl . "' target='_blank'>
                    <img class='media-object round-media' src='" . $logoUrl . "' alt='image' style='height: 60px; width: 40%'>
                </a>";
