                                            ...
                                            <div class="col-md-4">
                                               <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="status" id="status">
                                                        <option value="0" <?= ($seller['status'] == 0) ? 'selected' : '' ?>>Registered</option>
                                                        <option value="1" <?= ($seller['status'] == 1) ? 'selected' : '' ?>>Approved</option>
                                                        <option value="2" <?= ($seller['status'] == 2) ? 'selected' : '' ?>>Rejected</option>
                                                    </select>
                                                </div>
