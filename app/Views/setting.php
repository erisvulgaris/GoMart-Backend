                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10" style=" box-shadow: 0 0 10px rgb(0 0 0 / 13%), 0px 0px 10px rgb(0 0 0 / 0%); border-radius:5px;">
                                        ...
                                        <div class="tab-content" id="settingsTabContent">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="<?= isset($settings['mail_config']) && !$settings['demo_mode'] ? esc(json_decode($settings['mail_config'])->name) : '--------------------------' ?>" id="name" placeholder="Mailer Name" value="" class="form-control" name="name">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Host</label>
                                                                <input type="text" value="<?= isset($settings['mail_config']) && !$settings['demo_mode'] ? esc(json_decode($settings['mail_config'])->host) : '--------------------------' ?>" id="host" placeholder="Host" value="" class="form-control" name="host">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Email Id/ Username</label>
                                                                <input type="text" value="<?= isset($settings['mail_config']) && !$settings['demo_mode'] ? esc(json_decode($settings['mail_config'])->username) : '--------------------------' ?>" placeholder="Email Id/ Username" id="username" value="" class="form-control" name="username" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Password</label>
                                                                <input type="text" value="<?= isset($settings['mail_config']) && !$settings['demo_mode'] ? esc(json_decode($settings['mail_config'])->password) : '--------------------------' ?>" id="password" placeholder="Password" value="" class="form-control" name="password" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="<?= isset($settings['map_api_key']) && !$settings['demo_mode']  ? esc($settings['map_api_key']) : '--------------------------' ?>" id="map_api_key" placeholder="Map API Key" value="" class="form-control" name="map_api_key">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Google Speech To Text API Key</label>
                                                                <input type="text" value="<?= isset($settings['google_speech_api']) && !$settings['demo_mode']  ? esc($settings['google_speech_api']) : '--------------------------' ?>" id="google_speech_api" placeholder="Google Speech To Text API Key" value="" class="form-control" name="google_speech_api">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="<?= isset($settings['google_recaptcha_site_key']) && !$settings['demo_mode']  ? esc($settings['google_recaptcha_site_key']) : '--------------------------' ?>" id="google_recaptcha_site_key" placeholder="Site Key" value="" class="form-control" name="google_recaptcha_site_key">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Secret Key</label>
                                                                <input type="text" value="<?= isset($settings['google_recaptcha_secret_key']) && !$settings['demo_mode']  ? esc($settings['google_recaptcha_secret_key']) : '--------------------------' ?>" id="google_recaptcha_secret_key" placeholder="Secret Key" value="" class="form-control" name="google_recaptcha_secret_key">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <button type="submit" class="btn btn-primary">Update</button>
                                                    ...
                                                    <div class="row google-login">
                                                        <div class="col-md-6">
                                                            <div class="form-group ">
                                                                ...
                                                                <input id="google_login_client_id" type="text" value="<?= isset($googleClientId) && !$settings['demo_mode']  ? esc($googleClientId) : '--------------------------' ?>" placeholder="Google Login Client Id" class="form-control" name="google_login_client_id">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group ">
                                                                ...
                                                                <input id="google_login_client_secret" type="text" value="<?= isset($googleClientSecret) && !$settings['demo_mode']  ? esc($googleClientSecret) : '--------------------------'  ?>" placeholder="Google Login Client Secret" class="form-control" name="google_login_client_secret">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <button type="submit" class="btn btn-primary">Update</button>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group ">
                                                                ...
                                                                <textarea id="firebase_admin_json_file_content" placeholder="Json Service File Content" class="form-control" rows="15" name="firebase_admin_json_file_content"><?= isset($settings['firebase_admin_json_file_content']) && !$settings['demo_mode'] ? esc($settings['firebase_admin_json_file_content']) : '--------------------------' ?></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group ">
                                                                ...
                                                                <input id="apiKey" type="text" value="<?= isset($settings['fcm_credentials']) && !$settings['demo_mode'] ? esc(json_decode($settings['fcm_credentials'])->apiKey) : '--------------------------' ?>" placeholder="API Key" class="form-control" name="apiKey">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group ">
                                                                ...
                                                                <input id="authDomain" type="text" value="<?= isset($settings['fcm_credentials']) && !$settings['demo_mode'] ? esc(json_decode($settings['fcm_credentials'])->authDomain) : '--------------------------' ?>" placeholder="Auth Domain" class="form-control" name="authDomain">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group ">
                                                                ...
                                                                <input id="storageBucket" type="text" value="<?= isset($settings['fcm_credentials']) && !$settings['demo_mode'] ? esc(json_decode($settings['fcm_credentials'])->storageBucket) : '--------------------------' ?>" placeholder="Storage Bucket" class="form-control" name="storageBucket">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group ">
                                                                ...
                                                                <input id="messagingSenderId" type="text" value="<?= isset($settings['fcm_credentials']) && !$settings['demo_mode'] ? esc(json_decode($settings['fcm_credentials'])->messagingSenderId) : '--------------------------' ?>" placeholder="Messaging Sender Id" class="form-control" name="messagingSenderId">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group ">
                                                                ...
                                                                <input id="projectId" type="text" value="<?= isset($settings['fcm_credentials']) && !$settings['demo_mode'] ? esc(json_decode($settings['fcm_credentials'])->projectId) : '--------------------------' ?>" placeholder="Project Id" class="form-control" name="projectId">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group ">
                                                                ...
                                                                <input id="appId" type="text" value="<?= isset($settings['fcm_credentials']) && !$settings['demo_mode'] ? esc(json_decode($settings['fcm_credentials'])->appId) : '--------------------------' ?>" placeholder="App Id" class="form-control" name="appId">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group ">
                                                                ...
                                                                <input id="measurementId" type="text" value="<?= isset($settings['fcm_credentials']) && !$settings['demo_mode'] ? esc(json_decode($settings['fcm_credentials'])->measurementId) : '--------------------------' ?>" placeholder="Measurement Id" class="form-control" name="measurementId">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group ">
                                                                ...
                                                                <input id="chatgpt_api_key" type="text" value="<?=  isset($settings['chatgpt_api_key']) && !$settings['demo_mode'] ? esc($settings['chatgpt_api_key']) : '--------------------------' ?>" placeholder="Chatgpt API Key" class="form-control" name="chatgpt_api_key">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group ">
                                                                ...
                                                                <textarea id="twak_live_chat_widget_code" placeholder="Twak Widget Code" class="form-control" name="twak_live_chat_widget_code" rows="4"><?= isset($settings['twak_live_chat_widget_code']) && !$settings['demo_mode'] ? esc($settings['twak_live_chat_widget_code']) : '--------------------------' ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <button type="submit" class="btn btn-primary">Update</button>
                                            ...
                                            <!-- System Info Tab -->
                                            <div class="tab-pane fade <?php echo isset($_GET['setting']) && $_GET['setting'] == 'sys-info' ? 'active show' : '' ?>" id="sys-info" role="tabpanel" aria-labelledby="sys-info-tab">
                                                <h5>System Info</h5>
                                                <hr>

                                                <?php
                                                $db2     = \Config\Database::connect();
                                                $cfgRow2 = $db2->tableExists('sys_config') ? $db2->table('sys_config')->where('cfg_id',1)->get()->getRowArray() : null;
                                                $isActive = ($cfgRow2 && $cfgRow2['cfg_state'] == 1);
                                                $lastSync = ($cfgRow2 && $cfgRow2['cfg_sync']) ? date('d M Y, h:i A', (int)$cfgRow2['cfg_sync']) : 'Never';
                                                $origin   = ($cfgRow2 && $cfgRow2['cfg_origin']) ? esc($cfgRow2['cfg_origin']) : '-';
                                                ?>

                                                <div class="row mb-4">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="text-muted text-xs text-uppercase font-weight-bold">Activation Status</label>
                                                            <p class="mb-0">
                                                                <?php if ($isActive): ?>
                                                                    <span class="badge badge-success px-3 py-2" style="font-size:13px;">
                                                                        <i class="fi fi-rr-check mr-1"></i> Active
                                                                    </span>
                                                                <?php else: ?>
                                                                    <span class="badge badge-danger px-3 py-2" style="font-size:13px;">
                                                                        <i class="fi fi-rr-cross-circle mr-1"></i> Inactive
                                                                    </span>
                                                                <?php endif; ?>
                                                            </p>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="text-muted text-xs text-uppercase font-weight-bold">Registered Domain</label>
                                                            <p class="mb-0 font-weight-bold"><?= $origin ?></p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label class="text-muted text-xs text-uppercase font-weight-bold">Last Verified</label>
                                                            <p class="mb-0 font-weight-bold"><?= $lastSync ?></p>
                                                        </div>
                                                    </div>
                                                </div>

                                                <hr>
                                                <h5 class="mt-4">Update Purchase Code</h5>
                                                <p class="text-muted text-sm mb-3">Use this if you have a new purchase code or need to re-activate on this domain.</p>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Purchase Code</label>
                                                            <input type="text" id="newPurchaseCode" class="form-control" placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 d-flex align-items-end">
                                                        <button id="activateBtn" class="btn btn-primary w-100" onclick="submitNewCode()">
                                                            <i class="fi fi-rr-refresh"></i> Activate
                                                        </button>
                                                    </div>
                                                </div>
