                            ...
                            <div class="card card-<?php echo $settings['primary_color'] ?>">
                                ...
                                <form class="form" method="post" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="noti_image_input">Image <small class="text-muted">(optional)</small></label>
                                            <input type="file" class="form-control-file" id="noti_image_input" accept="image/*">
                                            <input type="hidden" id="noti_image" name="noti_image">
                                            <div id="noti_image_preview" class="mt-2" style="display:none;">
                                                <img id="noti_img_thumb" src="" alt="preview" style="height:80px; border-radius:6px;">
                                                <a href="#" class="text-danger ml-2" id="noti_image_clear"><small>Remove</small></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                        <button type="button" id="send_notification" class="btn btn-primary" onclick="addNotification()">
                                            <span id="btn_send_text">Send Notification</span>
                                            <span id="btn_send_loader" style="display:none;"><i class="fa fa-spinner fa-spin"></i> Sending...</span>
                                        </button>
                                    </div>
                                </form>
                                <!-- /.card-body -->
