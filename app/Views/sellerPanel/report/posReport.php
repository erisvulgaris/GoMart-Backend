...
<head>
  ...
  <title>POS Report | <?= isset($settings['business_name']) ? esc($settings['business_name']) : '' ?></title>
...
<body class="sidebar-mini control-sidebar-slide-open text-sm  layout-fixed <?php echo  $settings['thememode'] == 'Light' ? '' : 'dark-mode'; ?> layout-navbar-fixed text-sm" id="body">
            ...
            <div class="col-md-12">
              <div class="card card-<?= $settings['primary_color'] ?>">
                <div class="card-header">
                  <h3 class="card-title">View POS Report</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <div class=" d-flex justify-content-between">
                    ...
                    <div class="mx-2">
                      ...
                      <select id="payment_methods" class=" form-control  primary-bprder filter-product">
                        <option value="">All Payment Methods</option>
                        <?php foreach ($pos_payment_methods as $pos_payment_method):
                        ?>
                          <option value="<?= esc($pos_payment_method['id']);
                                          ?>"><?= esc($pos_payment_method['name']);
                                              ?></option>
                        <?php endforeach;
                        ?>
                      </select>
                  ...
                  <table id="view_pos_report" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th>O. Id</th>
  ...
  <script src="<?= base_url('/assets/page-script/sellerPanel/posReport.js') ?>"></script>
