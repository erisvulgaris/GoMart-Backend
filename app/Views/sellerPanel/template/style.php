...
<style>
  ...
  /* Container for the buttons and search box to ensure they are aligned */
  ...
  /* Align buttons inline with the search box */
  .dataTables_wrapper .dt-buttons {
    margin-right: 10px;
    /* Space between buttons and search box */
  }

  /* Style for the DataTable buttons (Copy, CSV, Excel, etc.) */
  .dt-button {
    padding: 8px 14px;
    margin-right: 8px;
