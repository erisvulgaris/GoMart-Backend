...
<body class="sidebar-mini control-sidebar-slide-open text-sm layout-fixed <?php echo $settings['thememode'] == 'Light' ? '' : 'dark-mode'; ?> layout-navbar-fixed text-sm" id="body">
    ...
    <script>
        const POS = {
            ...
            loadTopProducts() {
                $.get('/seller/pos/getTopProducts', (response) => {
                    if (response.success) {
            ...
            addToCart(productId, variantId) {
                ...
                $.get('/seller/pos/getProductDetails', { 
            ...
            searchCustomers(keyword) {
                ...
                $.get('/seller/pos/searchCustomer', { keyword: keyword }, (response) => {
            ...
            holdOrder() {
                ...
                $.ajax({
                    url: '/seller/pos/saveCartSession',
                    method: 'POST',
            ...
            loadHoldOrder(index) {
                ...
                $.get('/seller/pos/getCartSession', { session_id: order.session_id }, (response) => {
            ...
            removeHoldOrder(index) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.post('/seller/pos/deleteCartSession', { session_id: order.session_id }, () => {
            ...
            loadHoldOrders() {
                ...
                $.get('/seller/pos/getCartSessions', (response) => {
                    ...
                    success: (response) => {
                        if (response.success) {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    const printUrl = '/seller/pos/printInvoice?order_id=' + response.db_order_id;
