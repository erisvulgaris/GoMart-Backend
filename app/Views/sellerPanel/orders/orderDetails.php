...
<body class="sidebar-mini control-sidebar-slide-open text-sm  layout-fixed <?php echo  $settings['thememode'] == 'Light' ? '' : 'dark-mode'; ?> layout-navbar-fixed text-sm" id="body">
                                    ...
                                    <div class="invoice p-3 mb-3" id="invoice">
                                        ...
                                        <div class="row invoice-info">
                                            ...
                                            <div class="col-sm-4 invoice-col">
                                                ...
                                                <br>
                                                <b>Order ID:</b> <span id="order_id"><?= $orderDetails['order_id'] ?></span><br>
                                                    ...
                                                    <tbody>
                                                        <?php if (!empty($orderProducts)) : ?>
                                                            <?php foreach ($orderProducts as $index => $product) : ?>
                                                                <tr>
                                                                    <td><?= $index + 1; ?></td>
                                                                    <td><a class="text-dark text-underline" href="/seller/product/view/<?= $product['product_id'] ?>"><?= htmlspecialchars($product['product_name'] . ' (' . $product['product_variant_name'] . ')'); ?></a></td>
    ...
    <script src="<?= base_url('/assets/page-script/sellerPanel/orders_details.js') ?>"></script>

    <script>
        $("#download-invoice").on('click', function() {
            $.ajax({
                url: "/seller/orders/download_invoice",
                type: "POST",
                data: {
        ...
        function updateStatus(status) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "/seller/orders/update_status",
                        type: "POST",
                        data: {
