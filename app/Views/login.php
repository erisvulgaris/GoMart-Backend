...
<head>
  ...
  <?= $this->include('template/loginstyle') ?>
...
<body class="hold-transition  <?php echo $settings['thememode'] == 'Light' ? '' : 'dark-mode' ?>   text-sm">
  ...
  <div class="auth-page row">
    <!-- Left Section -->
    <div class="login-left col-md-7 d-none d-md-flex">
    ...
    <div class="login-right col-md-5">
      <div class=" login-card">
        <div class=" login-card-body">
          ...
          <h2 class="d-block d-md-none "><?= isset($settings['business_name']) ? esc($settings['business_name']) : '' ?></h2>

          <h3 class=" mb-3">Admin Signin</h3>
          <p class="">Welcome back! Login to your panel.</p>
          <form action="/admin/auth/processLogin" id="loginForm" method="post">
            <?php
            if ($settings['google_recaptcha_status'] == 1) { ?>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="email" id="email" name="email" class="form-control" placeholder="Your Email" value="admin@gmail.com" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input type="password" id="password" name="password" class="form-control" placeholder="Password" value="demo1234" required>
                <div class="input-group-append">
            ...
            <div class="row">
              ...
              <div class="col-6 text-right">
                <p class="" style="color: #393f81;"> <button id="forgotpassword" class="btn p-0" type="button" onclick="forgotPassword()"
                    style="color: #71419f; font-weight:bold; text-decoration:underline">Forgot Password <i class="fi fi-bs-key"></i></button></p>
              </div>
            </div>
            ...
            <div class="form-group mt-3">
              <a href="/seller/auth/login" class="btn btn-primary btn-block">Seller Login</a>
            </div>
          </form>
        </div>
      </div>
  ...
  <script>
    ...
    function forgotPassword() {
      ...
      $.ajax({
        url: "/admin/auth/forgot-password/send-link",
        type: "POST",
        data: {
          email,
          <?php
