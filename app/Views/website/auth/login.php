        ...
        <div class="flex flex-wrap md:h-screen">
            <div class="flex w-screen flex-col lg:w-1/2">
                ...
                <div class="md:mx-[15%] mx-[5%] my-auto flex flex-col justify-center lg:justify-start py-6">
                    <p class="text-center text-xl md:text-3xl font-bold dark:text-white"><?php echo lang('website.welcome_back_user'); ?></p>
                    <p class="mt-2 text-center text-gray-500 dark:text-gray-400"><?php echo lang('website.welcome_to'); ?> <?= $settings['business_name'] ?>. <?php echo lang('website.please_log_in_or_sign_up'); ?></p>
                    ...
                    if (!empty($loginSettings) && $loginSettings[0]['login_medium'] === 'google' && $loginSettings[0]['status'] === '1'): ?>
                        <a href="<?= $authUrl ?>" id="login_with_google_link" class="-2 mt-8 flex items-center justify-center rounded-md bg-white dark:bg-gray-800 shadow-sm border border-green-500 dark:border-green-600 px-4 py-1 outline-none transition hover:border-transparent hover:bg-green-700 hover:text-white dark:text-gray-200 dark:hover:bg-green-700">
                    ...
                    <?php if ($settings['phone_login'] === '1'): ?>
                        <a href="/mobileLogin" id="" class="-2 mt-8 flex items-center justify-center rounded-md bg-white dark:bg-gray-800 shadow-sm border border-green-500 dark:border-green-600 px-4 py-1 outline-none transition hover:border-transparent hover:bg-green-700 hover:text-white dark:text-gray-200 dark:hover:bg-green-700">
                    ...
                    <?php if ($settings['direct_login'] == 1): ?>
                        <form class="flex flex-col pt-3 md:pt-8">
                            ...
                            <div class="flex flex-col pt-4">
                                ...
                                <div class="flex items-center border border-gray-300 dark:border-gray-600 rounded-lg focus-within:border-green-600 focus-within:shadow-[0_0_0_.25rem_rgba(10,173,10,.25)] dark:bg-gray-800">
                                    ...
                                    <input type="password" id="password" name="password" class="text-gray-900 dark:text-gray-100 dark:bg-gray-800 focus:ring-0 focus:border-0 block p-2 w-full text-base border-0 disabled:opacity-50 disabled:pointer-events-none" placeholder="<?php echo lang('website.enter'); ?> <?php echo lang('website.password'); ?>">
                            ...
                            <div class="text-right mb-6 pt-4">
                                <a href="/resetPassword" class="underline-offset-4 font-semibold text-green-700 dark:text-green-400 underline"><?php echo lang('website.forget_password'); ?></a>
                            </div>
                        ...
                        <div class="pt-6 text-center">
                            <p class="whitespace-nowrap text-gray-600 dark:text-gray-400">
                                ...
                                <a href="/signup" class="underline-offset-4 font-semibold text-green-700 dark:text-green-400 underline"><?php echo lang('website.sign_up_for_free'); ?></a>
                            </p>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="pointer-events-none relative hidden select-none bg-white dark:bg-gray-900 lg:block lg:w-1/2">
                <img class="absolute top-0 h-full w-full dark:brightness-75" src="<?= base_url('/assets/dist/img/login-banner.svg') ?>" />
            </div>
        </div>
