        ...
        <div class="flex flex-wrap h-screen">
            <div class="flex w-screen flex-col lg:w-1/2">
                ...
                <div class="md:mx-[15%] mx-[5%] my-auto flex flex-col justify-center lg:justify-start py-6">
                    <p class="text-center text-xl md:text-3xl font-bold dark:text-white"><?php echo lang('website.create_your_account'); ?></p>
                    <p class="mt-2 text-center text-gray-500 dark:text-gray-400"><?php echo lang('website.welcome_to'); ?> <?= $settings['business_name'] ?>. <?php echo lang('website.lets_create_your_account'); ?></p>
                    <form class="flex flex-col pt-3 md:pt-8">
                        <!-- Name -->
                        <div class="flex flex-col pt-4">
                            <label class="text-gray-800 dark:text-gray-200 font-medium inline-block" for="name">
                            ...
                            <div class="flex items-center border border-gray-300 dark:border-gray-600 rounded-lg focus-within:border-green-600 focus-within:shadow-[0_0_0_.25rem_rgba(10,173,10,.25)] dark:bg-gray-800">
                                ...
                                <input type="text" id="name" name="name" class="text-gray-900 dark:text-gray-100 dark:bg-gray-800 focus:ring-0 focus:border-0 block p-2 w-full text-base border-0 disabled:opacity-50 disabled:pointer-events-none" placeholder="<?php echo lang('website.enter'); ?> <?php echo lang('website.name'); ?>" autocomplete="off">
                            </div>
                        ...
                        <!-- Mobile -->
                        <div class="flex flex-col pt-4">
                            <label class="text-gray-800 dark:text-gray-200 font-medium inline-block" for="mobile">
                            ...
                            <div class="flex items-center border border-gray-300 dark:border-gray-600 rounded-lg focus-within:border-green-600 focus-within:shadow-[0_0_0_.25rem_rgba(10,173,10,.25)] dark:bg-gray-800">
                                ...
                                <input type="text" id="mobile" name="mobile" class="text-gray-900 dark:text-gray-100 dark:bg-gray-800 focus:ring-0 focus:border-0 block p-2 w-full text-base border-0 disabled:opacity-50 disabled:pointer-events-none" placeholder="<?php echo lang('website.enter'); ?> <?php echo lang('website.mobile'); ?>" autocomplete="off">
                            </div>
                        ...
                        <div class="flex flex-col pt-4">
                            ...
                            <div class="flex items-center border border-gray-300 dark:border-gray-600 rounded-lg focus-within:border-green-600 focus-within:shadow-[0_0_0_.25rem_rgba(10,173,10,.25)] dark:bg-gray-800">
                                ...
                                <input type="email" id="email" name="email" class="text-gray-900 dark:text-gray-100 dark:bg-gray-800 focus:ring-0 focus:border-0 block p-2 w-full text-base border-0 disabled:opacity-50 disabled:pointer-events-none" placeholder="<?php echo lang('website.enter'); ?> <?php echo lang('website.email'); ?>" autocomplete="off">
                            </div>
                        ...
                        <!-- Password -->
                        <div class="flex flex-col pt-4">
                            <label class="text-gray-800 dark:text-gray-200 font-medium inline-block" for="password">
                            ...
                            <div class="flex items-center border border-gray-300 dark:border-gray-600 rounded-lg focus-within:border-green-600 focus-within:shadow-[0_0_0_.25rem_rgba(10,173,10,.25)] dark:bg-gray-800">
                                ...
                                <input type="password" id="password" name="password" class="text-gray-900 dark:text-gray-100 dark:bg-gray-800 focus:ring-0 focus:border-0 block p-2 w-full text-base border-0 disabled:opacity-50 disabled:pointer-events-none" placeholder="<?php echo lang('website.enter'); ?> <?php echo lang('website.password'); ?>" autocomplete="off">
                                <span class="px-3 text-gray-500 dark:text-gray-400 cursor-pointer" onclick="togglePasswordVisibility()">
                        ...
                        <!-- Confirm Password -->
                        <div class="flex flex-col pt-4">
                            <label class="text-gray-800 dark:text-gray-200 font-medium inline-block" for="confirmPassword">
                            ...
                            <div class="flex items-center border border-gray-300 dark:border-gray-600 rounded-lg focus-within:border-green-600 focus-within:shadow-[0_0_0_.25rem_rgba(10,173,10,.25)] dark:bg-gray-800">
                                ...
                                <input type="password" id="confirmPassword" name="confirmPassword" class="text-gray-900 dark:text-gray-100 dark:bg-gray-800 focus:ring-0 focus:border-0 block p-2 w-full text-base border-0 disabled:opacity-50 disabled:pointer-events-none" placeholder="<?php echo lang('website.enter'); ?> <?php echo lang('website.confirm_password'); ?>" autocomplete="off">
                                <span class="px-3 text-gray-500 dark:text-gray-400 cursor-pointer" onclick="toggleConfirmPasswordVisibility()">
                        ...
                        <!-- Referral Code -->
                        <div class="flex flex-col pt-4">
                            <label class="text-gray-800 dark:text-gray-200 font-medium inline-block" for="referal">
                            ...
                            <div class="flex items-center border border-gray-300 dark:border-gray-600 rounded-lg focus-within:border-green-600 focus-within:shadow-[0_0_0_.25rem_rgba(10,173,10,.25)] dark:bg-gray-800">
                                ...
                                <input type="text" id="referal" name="referal" class="text-gray-900 dark:text-gray-100 dark:bg-gray-800 focus:ring-0 focus:border-0 block p-2 w-full text-base border-0 disabled:opacity-50 disabled:pointer-events-none" placeholder="<?php echo lang('website.enter'); ?> <?php echo lang('website.referal_code'); ?>" autocomplete="off">
                            </div>
                        ...
                        <!-- Terms & Conditions -->
                        <div class="mb-6 mt-2">
                            <p class="text-gray-400 dark:text-gray-500 text-sm"><?php echo lang('website.by_signing_up_you_agree_to_our'); ?> <a href="#" class="text-green-700 dark:text-green-400 underline"><?php echo lang('website.terms_condition'); ?></a> <?php echo lang('website.and'); ?> <a href="#" class="text-green-700 dark:text-green-400 underline"><?php echo lang('website.privacy_policy'); ?></a>.</p>
                        </div>
                    ...
                    <div class="relative mt-8 flex h-px place-items-center bg-green-200 dark:bg-green-900">
                        <div class="absolute left-1/2 h-6 w-14 -translate-x-1/2 bg-white dark:bg-gray-950 text-center text-sm text-gray-500 dark:text-gray-400"><?php echo lang('website.or'); ?></div>
                    </div>
                    <div class="pt-6 text-center mb-[20%] md:mb-0">
                        <p class="whitespace-nowrap text-gray-600 dark:text-gray-400">
                            ...
                            <a href="/login" class="underline-offset-4 font-semibold text-green-700 dark:text-green-400 underline"><?php echo lang('website.login_here'); ?></a>
                        </p>
                    </div>
                </div>
            </div>
            <div class="pointer-events-none relative hidden select-none bg-white dark:bg-gray-900 lg:block lg:w-1/2">
                <img class="absolute top-0 h-full w-full dark:brightness-75" src="<?= base_url('/assets/dist/img/signup-banner.svg') ?>" />
            </div>
        </div>
