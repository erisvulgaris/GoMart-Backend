        ...
        <div class="flex flex-wrap md:h-screen">
            <div class="flex w-screen flex-col lg:w-1/2">
                ...
                <div class="md:mx-[15%] mx-[5%] my-auto flex flex-col justify-center lg:justify-start py-6">
                    <p class="text-center text-xl md:text-3xl font-bold dark:text-white"><?php echo lang('website.login_with_mobile_number'); ?></p>
                    <p class="mt-2 text-center text-gray-500 dark:text-gray-400"><?php echo lang('website.enter_your_mobile_number_and_get_otp'); ?></p>
                    <form class="flex flex-col pt-3 md:pt-8">
                        ...
                        <div class="flex flex-col pt-4">
                            ...
                            <div class="flex items-center border border-gray-300 dark:border-gray-600 rounded-lg focus-within:border-green-600 focus-within:shadow-[0_0_0_.25rem_rgba(10,173,10,.25)] dark:bg-gray-800">
                                ...
                                <input data-validation-no="<?= $country['validation_no'] ?> type=" number" id="mobile" name="mobile" class="text-gray-900 dark:text-gray-100 dark:bg-gray-800 focus:ring-0 focus:border-0 block p-2 w-full text-base border-0 disabled:opacity-50 disabled:pointer-events-none" placeholder="<?php echo lang('website.enter'); ?> <?php echo lang('website.mobile'); ?>">
                            </div>
                    ...
                    <?php if ($settings['direct_login'] == 1): ?>
                        <div class="relative mt-8 flex h-px place-items-center bg-green-200 dark:bg-green-900">
                            <div class="absolute left-1/2 h-6 w-14 -translate-x-1/2 bg-white dark:bg-gray-950 text-center text-sm text-gray-500 dark:text-gray-400">or</div>
                        </div>
            ...
            <div class="pointer-events-none relative hidden select-none bg-white dark:bg-gray-900 lg:block lg:w-1/2">
                <img class="absolute top-0 h-full w-full dark:brightness-75" src="<?= base_url('/assets/dist/img/mobile-login-banner.svg') ?>" />
            </div>
        </div>
