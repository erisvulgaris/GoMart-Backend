        ...
        <section class="mt-2 md:mt-4 md:container md:mx-auto px-3">
            <div class="relative flex flex-col min-w-0 rounded-lg break-words bg-white p-4 mb-6">
                <div class="flex justify-between">
                    <h1 class="text-base font-medium z-10"><?php echo lang('website.buy');?> <?= $category['category_name'] ?> <?php echo lang('website.online');?></h1>
                </div>
            </div>
        </section>

        <section class="mt-2 md:mt-4 md:container md:mx-auto md:px-3">
            <div class="grid grid-cols-9 gap-3 md:gap-5">
                <div class="col-span-2 ">
                    <div class="bg-white flex flex-col items-center rounded-lg md:hidden">

                        <?php $first = true;
                        foreach ($subcategories as $subcategory):  if ($first): ?>
                                <a href="<?= base_url('subcategory/' . $subcategory['slug']) ?>" class="py-2 w-full">
                                    <div class="w-full h-full">
                                        <div id="category_1" class="relative flex flex-col items-center justify-center gap-1">
                                            ...
                                            <div class="text-black font-semibold text-sm text-center w-4/5 break-words"><?= $subcategory['name'] ?></div>
                ...
                <div class="col-span-7 md:bg-white rounded-lg">
                    <div class="grid grid-cols-2 xl:grid-cols-6 lg:grid-cols-4 md:grid-cols-3 gap-2 md:p-2">
                            ...
                            <div class="rounded-lg bg-white border border-green-500" id="<?= $product['slug'] ?>">
                                <div class="flex-auto p-2">
                                    ...
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <span class="productDeliveryTime text-xs text-green-600 font-medium hidden"><i class="fi fi-rr-clock"></i> <span class="productDeliveryTimeVal"></span> min delivery</span>
