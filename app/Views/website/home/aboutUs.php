        ...
        <section class="mt-2 md:mt-4 md:container md:mx-auto px-3">
            <div class="row bg-white dark:bg-gray-800 mb-2 p-4 rounded-lg">
                <div class="flex justify-between">
                    <h2 class="text-lg font-medium z-10 dark:text-white"><?php echo lang('website.about_us'); ?></h2>
                </div>
            </div>
            <div class="bg-white dark:bg-gray-800 rounded-lg px-4 py-2 policyclass dark:text-gray-300">
                    <?= $aboutUs; ?>
            </div>
        </section>
