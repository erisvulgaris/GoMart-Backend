        ...
        <section class="mt-2 md:mt-4 md:container md:mx-auto px-3">
            <div class="row bg-white dark:bg-gray-800 mb-2 p-4 rounded-lg">
                <div class="flex justify-between">
                    <h2 class="text-lg font-medium z-10 dark:text-white"><?php echo lang('website.contact_us'); ?></h2>
                </div>
            </div>

            <div class="bg-white dark:bg-gray-800 rounded-lg px-4 py-2">
                <div class="grid md:p-2 mx-3 md:mx-0">
                    <ul class="flex flex-col gap-2">
                        <?php if (isset($settings['phone']) && $settings['phone'] != null && $settings['phone'] != ''): ?>
                            <li>
                                <a href="tel:<?= htmlspecialchars($settings['phone']); ?>" class="inline-block hover:text-green-600 dark:hover:text-green-400 text-sm font-medium dark:text-gray-200">
                        ...
                        <?php if (isset($settings['email']) && $settings['email'] != null && $settings['email'] != ''): ?>
                            <li>
                                <a href="mailto:<?= htmlspecialchars($settings['email']); ?>" class="inline-block hover:text-green-600 dark:hover:text-green-400 text-sm font-medium dark:text-gray-200">
                        ...
                        ?>
                            <li>
                                <a href="<?= htmlspecialchars($googleMapsLink); ?>" target="_blank" class="inline-block hover:text-green-600 dark:hover:text-green-400 text-sm font-medium dark:text-gray-200">
