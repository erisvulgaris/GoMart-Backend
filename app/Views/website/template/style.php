...
<script>
    tailwind.config = {
        darkMode: 'class', // ✅ only change needed
    }
</script>
...
<style>
    ...
    /* Fix Tailwind preflight breaking Google Maps tiles */
    .gm-style img { max-width: none !important; height: auto !important; }
    .gm-style { font-size: initial; }
</style>