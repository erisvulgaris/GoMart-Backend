        ...
        <section class="mt-2 md:mt-4 md:container md:mx-auto px-3">
            <div class="row bg-white dark:bg-gray-800 mb-2 p-4 rounded-lg">
                <div class="flex justify-between">
                    <h2 class="text-lg font-medium z-10 dark:text-white"><?php echo lang('website.address'); ?></h2>
                </div>
            </div>
        </section>
        <section class="mt-2 md:mt-4 md:container md:mx-auto md:px-3">
            ...
            <div class="flex flex-wrap lg:flex-nowrap lg:gap-x-6 gap-y-6">
                ...
                <div class="w-full lg:w-full md:w-full mx-auto">
                    <div class="mb-2 rounded-lg bg-white dark:bg-gray-800">
                        <div class="flex items-center justify-between gap-3 p-4 border-b border-gray-100 dark:border-gray-700">
                            <h4 class="font-bold capitalize dark:text-white"> <?php echo lang('website.delivery_address'); ?></h4>
                            <div class="flex items-center gap-4">
                                <button type="button" onclick="openAddressPopup()"
                                    class="px-3 h-8 leading-8 rounded-lg flex items-center gap-2 bg-[#FFF4F1] dark:bg-red-900/20 text-primary">
                                    <i class="fi fi-tr-add"></i>
                                    <span class="text-sm font-medium capitalize whitespace-nowrap text-red-600 dark:text-red-400"><?php echo lang('website.add_new'); ?></span>
                                </button>
                            </div>
                        </div>
            ...
            try {
                ...
                if (result.status === 'success') {
                    ...
                    if (!addressWithActiveStatus && addressesWithInActiveStatus.length === 0) {
                        noaddressfound.innerHTML = '<div class="flex flex-col gap-4 text-center"><img src="<?= base_url('assets/dist/img/no-data.png') ?>" alt="" class="mx-auto w-2/3 sm:w-1/3 rounded-lg" /><div class="text-sm text-gray-700 dark:text-gray-400">No Order History Available</div></div>';
                    }
                } else {
