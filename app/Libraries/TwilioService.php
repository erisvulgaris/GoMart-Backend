...
class TwilioService
{
    ...
    {
        $accountSid = getenv('TWILIO_ACCOUNT_SID') ?: 'YOUR_TWILIO_ACCOUNT_SID';
        $authToken = getenv('TWILIO_AUTH_TOKEN') ?: 'YOUR_TWILIO_AUTH_TOKEN';
        $this->fromNumber = getenv('TWILIO_FROM_NUMBER') ?: 'YOUR_TWILIO_FROM_NUMBER';
